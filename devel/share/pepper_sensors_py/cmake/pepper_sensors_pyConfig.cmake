...
if("TRUE" STREQUAL "TRUE")
  set(pepper_sensors_py_SOURCE_PREFIX /root/catkin_ws/src/pepper_robot/pepper_sensors_py)
  set(pepper_sensors_py_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(pepper_sensors_py_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pepper_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/pepper_robot/pepper_sensors_py/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pepper_sensors_py_EXPORTED_TARGETS ${${pepper_sensors_py_dep}_EXPORTED_TARGETS})
endforeach()
